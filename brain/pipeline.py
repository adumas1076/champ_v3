...
class BrainPipeline:
    ...
    3. Build enriched context (persona + mode instructions)
    4. Forward to LiteLLM with enriched context
    5. Return response that sounds like Champ
    """
    ...
    async def handle_stream(
        ...
        logger.info(
            ...
            f"{len(full_response)} chars, {elapsed:.1f}s"
        )
